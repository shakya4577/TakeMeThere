...
extension NewUserViewController
{
    func setupUI()
    {
        ...
        middleLine.layer.cornerRadius = 4
        let googleSignInButton = GIDSignInButton(frame: CGRect(x: txtField.frame.minX, y: middleLine.frame.maxY+20, width: txtField.frame.width, height: txtField.frame.height))
        
        formView.addSubview(googleSignInButton)
